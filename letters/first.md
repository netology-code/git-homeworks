...
С 30 июня 2021 года GitHub перешёл на авторизацию при помощи так называемого токена. Его нужно сгенерировать в настройках вашего профиля на сайте и сохранить в надёжном месте. Вы будете указывать этот токен в качестве пароля при работе с репозиториями.
