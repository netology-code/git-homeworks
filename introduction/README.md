...
1. Добавьте описание README.md в Markdown ([пример структуры описания](https://github.com/netology-code/git-homeworks/blob/master/introduction/example.md)) и сделайте коммит;
