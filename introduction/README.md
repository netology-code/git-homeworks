...
1. Получите [по ссылке](https://github.com/netology-code/git-homeworks/raw/master/introduction/src/neuro-startup.zip) архив с проектом и распакуйте его.
1. Создайте на базе папки `1.2. Site For Import` Git-репозиторий.
    * Система macOS создаёт автоматическую скрытую папку `__MACOSX `, в задаче она не используется.
