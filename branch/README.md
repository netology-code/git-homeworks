...
1. Возьмите ваш репозиторий из [задачи 1.1](../introduction);
...
1. Убедитесь, что ветка **feature/code-completion** тоже попала на GitHub. В итоге в вашем проекте должно получится две ветки.
